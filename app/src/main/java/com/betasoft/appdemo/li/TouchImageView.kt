...
import com.betasoft.appdemo.li.*
import com.betasoft.appdemo.utils.Utils.isTIRAMISU
...
open class TouchImageView @JvmOverloads constructor(
    ...
    public override fun onRestoreInstanceState(state: Parcelable) {
        if (state is Bundle) {
            ...
            viewSizeChangeFixedPixel = if (isTIRAMISU()) {
                state.getSerializable("viewSizeChangeFixedPixel", FixedPixel::class.java)
            } else @Suppress("DEPRECATION") state.getSerializable("viewSizeChangeFixedPixel") as FixedPixel?
            orientationChangeFixedPixel = if (isTIRAMISU()) {
                state.getSerializable("orientationChangeFixedPixel", FixedPixel::class.java)
            ...
            if (isTIRAMISU()) {
                ...
                @Suppress("DEPRECATION") super.onRestoreInstanceState(state.getParcelable("instanceState"))
            }
            return
        }
